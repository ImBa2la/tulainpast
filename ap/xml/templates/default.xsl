...
<xsl:variable name="_usr" select="/page/site/users/user[@selected]"/>
...
<nav>
	...
	<aside>
		...
		<xsl:apply-templates select="/page/site/users/user[@selected]"/>
...
<footer><p>© Forumedia 2012</p></footer>
</body>
</html>
</xsl:template>

<xsl:template match="/page/site/users/user[@selected]">
	<p class="profile">
		<xsl:choose>
